                ...
                <ul class="navbar-nav">
                    ...
                    @else
                        ...
                        <li class="nav-item ps-2">
                            <a class="nav-link fw-bold btn btn-warning text-black active" href="{{route('show_profile')}}">Profile</a>
                        </li>
                        <li class="nav-item ps-2">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                            ...
                            <form action="{{route('edit_profile')}}" method="post">
                                ...
                                <button type="submit" class="btn btn-warning fw-bold mt-3">Change Profile Details</button>
                            </form>
                        </div>
                    </div>
                </div>
