                                        ...
                                        <div class="row gx-5">
                                            <div class="col">
                                                <a href="{{route('show_order', $order)}}">
                                                    <button class="btn btn-warning fw-bold" type="button">Check Invoice {{$order->id}}</button>
                                                </a>
                                            </div>
                                            <div class="col">
                                                <a href="{{route('show_order', $order)}}">
                                                    <button class="btn btn-success fw-bold" type="button">Check Form Grooming {{$order->id}}</button>
                                                </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="container px-1">
                                        <div class="row gx-5">
                                            ...
                                            <div class="col">
                                                <a href="{{route('show_order', $order)}}">
                                                    <button class="btn btn-success fw-bold" type="button">Check Form Pet Hotel {{$order->id}}</button>
                                                </a>
                                        </div>
                                    </div>
                                </div>
