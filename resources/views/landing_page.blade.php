<x-user-page>
    ...
    <section id="tentang-kami" class="tentang-kami-container container">
        ...
        <div style="text-align: center;">
            ...
            <br>
            <h4><strong class="fw-bold text-warning">Orino Petshop</strong> hadir untuk memenuhi kebutuhan hewan
                peliharaan Anda. Tersedia layanan grooming,
    ...
    <section id="feedback" class="contact-container mt-4">
        ...
        <div class="row">
            <div class="col-12 col-lg-6">
                <p class="contact-detail text-center fw-bold">Berikan Kami feedback atau masukkan
                ...
                <form class="contact-form ms-4 border-0 shadow" action="{{ route('feedback.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="subject" id="inp-password" placeholder="Subject"
                            required>
                    </div>
                    <div class="mb-3">
                        <label for="inp-message" class="form-label fw-bold">Message</label>
                        <input type="text" class="form-control" id="inp-message" name="message" placeholder="Pesan"
                            required>
                    </div>
            ...
            <div class="col-12 col-lg-6">
                <h4 class="text-center fw-bold pt-5 pt-lg-0">Review Pelanggan Orino</h4>
                <div class="card rounded-2 border-0 shadow card-review">
                    <div class="card-body">
                        <div class="row h-100">
                            <div class="col-4 col-lg-4 d-flex flex-col">
                                <div
                                    class="my-4 mx-0 bg-warning rounded-2 h-50 my-auto w-100 h-50 d-flex justify-content-center align-items-center">
                                    <h2 class="text-center text-white fw-bold m-0">{{ round($average_total, 2) }} <i
                                            class="fa-solid fa-star"> </i> </h2>
                                </div>
                            </div>
                            <div class="col-8 col-lg-8 d-flex flex-column justify-content-center">
                                <div class="my-4 d-flex flex-column justify-content-around h-75">
                                    <div class="d-flex w-100 align-items-center">
                                        <div class="w-25">
                                            <h6 class="text-center fw-bold m-0 text-warning">Kualitas</h6>
                                        </div>
                                        <div class="progress w-75" style="height:1.5rem;">
                                            <div class="progress-bar bg-warning" role="progressbar"
                                                style="width: {{ round($average[0]->kualitas, 2) / 5 * 100 }}%;"
                                                aria-valuenow="{{ round($average[0]->kualitas, 2) }}" aria-valuemin="0"
                                                aria-valuemax="5">{{ round($average[0]->kualitas, 2) }}</div>
                                        </div>
                                    </div>
                                    <div class="d-flex w-100 align-items-cente">
                                        <div class="w-25">
                                            <h6 class="text-center fw-bold m-0 text-warning">Pelayanan</h6>
                                        </div>
                                        <div class="progress w-75" style="height:1.5rem;">
                                            <div class="progress-bar bg-warning" role="progressbar"
                                                style="width: {{ round($average[0]->pelayanan, 2) / 5 * 100 }}%;"
                                                aria-valuenow="{{ round($average[0]->pelayanan, 2) }}" aria-valuemin="0"
                                                aria-valuemax="5">{{ round($average[0]->pelayanan, 2) }}</div>
                                        </div>
                                    </div>
                                    <div class="d-flex w-100 align-items-cente">
                                        <div class="w-25">
                                            <h6 class="text-center fw-bold m-0 text-warning">Harga</h6>
                                        </div>
                                        <div class="progress w-75" style="height:1.5rem;">
                                            <div class="progress-bar bg-warning" role="progressbar"
                                                style="width: {{ round($average[0]->harga, 2) / 5 * 100 }}%;"
                                                aria-valuenow="{{ round($average[0]->harga, 2) }}" aria-valuemin="0"
                                                aria-valuemax="5">{{ round($average[0]->harga, 2) }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="user-reviews my-4">
                    <div id="reviews" class="carousel slide" data-bs-ride="carousel">
                        <!-- Indicators/dots -->
                        <div class="carousel-indicators mb-4">
                            @foreach ($reviews as $key => $item)
                            <button type="button" data-bs-target="#reviews" data-bs-slide-to="{{ $key }}"
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item {{ $key == 0? 'active' : '' }}"
                                ...
                                <div class="card border-0 py-4 px-2 w-75 mx-auto card-review">
                                    <div class="card-body">
                                        <h5 class="text-center">{{ substr($item->order->user->name, 0, -2) . '**' }}</h5>
                                        <div class="row h-100">
                                            <div class="col-4 col-lg-4 d-flex flex-col">
                                                <div
                                                    class="my-4 mx-0 bg-warning rounded-2 h-50 my-auto w-100 h-50 d-flex justify-content-center align-items-center">
                                                    <h2 class="text-center text-white fw-bold m-0">
                                                        {{ round(($item->kualitas + $item->harga + $item->pelayanan) / 3, 2) }} <i class="fa-solid fa-star"> </i>
                                                    </h2>
                                                </div>
                                            </div>
                                            <div class="col-8 col-lg-8 d-flex flex-column justify-content-center">
                                                <div class="my-4 d-flex flex-column justify-content-around h-75">
                                                    <div class="d-flex w-100 align-items-center">
                                                        <div class="w-25">
                                                            <h6 class="text-center fw-bold m-0 text-warning">Kualitas
                                                            </h6>
                                                        </div>
                                                        <div class="progress w-75" style="height:1.5rem;">
                                                            <div class="progress-bar bg-warning" role="progressbar"
                                                                style="width: {{ round($item->kualitas, 2) / 5 * 100 }}%;"
                                                                aria-valuenow="{{ round($item->kualitas, 2) }}"
                                                                aria-valuemin="0" aria-valuemax="5">
                                                                {{ round($item->kualitas, 2) }}</div>
                                                        </div>
                                                    </div>
                                                    <div class="d-flex w-100 align-items-cente">
                                                        <div class="w-25">
                                                            <h6 class="text-center fw-bold m-0 text-warning">Pelayanan
                                                            </h6>
                                                        </div>
                                                        <div class="progress w-75" style="height:1.5rem;">
                                                            <div class="progress-bar bg-warning" role="progressbar"
                                                                style="width: {{ round($item->pelayanan, 2) / 5 * 100 }}%;"
                                                                aria-valuenow="{{ round($item->pelayanan, 2) }}"
                                                                aria-valuemin="0" aria-valuemax="5">
                                                                {{ round($item->pelayanan, 2) }}</div>
                                                        </div>
                                                    </div>
                                                    <div class="d-flex w-100 align-items-cente">
                                                        <div class="w-25">
                                                        ...
                                                        <div class="progress w-75" style="height:1.5rem;">
                                                            <div class="progress-bar bg-warning" role="progressbar"
                                                                style="width: {{ round($item->harga, 2) / 5 * 100 }}%;"
                                                                aria-valuenow="{{ round($item->harga, 2) }}"
                                                                aria-valuemin="0" aria-valuemax="5">
                                                                {{ round($item->harga, 2) }}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <button class="carousel-control-prev" type="button" data-bs-target="#reviews"
                            data-bs-slide="prev">
                            <span class="carousel-control-prev-icon"></span>
                        </button>

                        <button class="carousel-control-next" type="button" data-bs-target="#reviews"
                            data-bs-slide="next">
                            <span class="carousel-control-next-icon"></span>
                        </button>
                    </div>
