                ...
                eventClick: function (info) {
                    if (info.event.extendedProps.available == false) {
                        Swal.fire({
                            ...
                            text: "Silahkan Pilih Jadwal Lain",
                        });
                    } else {
                        document.getElementById('formSection').scrollIntoView({
                            behavior: 'smooth'
                        });
                        $('input[name=date]').val(moment(info.event.start).format('YYYY-MM-DD'))
                        $('input[name=session]').val(moment(info.event.start).format('HH:mm'))
                        $('input[name=grooming_schedule_id]').val(info.event.extendedProps
