<x-dashboard>
    @slot('content')
    <div class="container">
        <h1 class="text-center pd-4">Tambah Order Pet Hotel</h1>
        <hr>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 col-12">
                    <div class="card text-gray fw-bold">
                        {{-- <div class="card-header h4 fw-bold" style="background-color: #FFEFB0">{{ __('Form Pet Hotel') }}
                    </div> --}}
                    <div class="card-header h4 fw-bold" style="background-color: #FFEFB0">{{ __('Lihat Jadwal Pet Hotel') }}
                    </div>
                    <div class="card-body">
                        {{-- <h4 class="fw-bold">Pilih Hari Pemesanan</h4> --}}
                        <div class="my-3" id="calendar"></div>

                        @if (Route::is('admin.pethotel.create'))
                        <form id="groomingForm" action="{{ route('pethotel.store') }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-lg-6 col">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="start_date" placeholder="" class="form-control" required value="{{ $start_date }}"><br>
                                    </div>
                                </div>
                                <div class="col-lg-6 col">
                                    <div class="form-group">
                                        <label>Tanggal Akhir Pemesanan</label>
                                        <input type="date" name="end_date" placeholder="" class="form-control" required value="{{ $end_date }}"
                                            readonly><br>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Email Akun Terdaftar</label>
                                <input type="text" name="email" placeholder="Nama" class="form-control" required><br>
                            </div>
                            <div class="form-group">
                                <label>Alamat</label>
                            ...
                            <div class="form-group">
                                <label>No.HP</label>
                                <input type="text" name="phone_number" placeholder="08..." class="form-control" required><br>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="pet_age" placeholder="Usia Kucing" class="form-control" required><br>
                            </div>
                            <div class="form-group">
                                <label>Merk Pakan</label>
                                <input type="text" name="pet_food" placeholder="Merk Makanan" class="form-control" required><br>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="1" id="flexCheckIndeterminate" name="vaccine">
                            ...
                            {{-- <div class="container text-center">
                                ...
                                <button type="submit" class="btn btn-primary mt-3" id="submitBtn">Submit
                                    Data</button>
                            </div>
                        </form>
                        @endif
